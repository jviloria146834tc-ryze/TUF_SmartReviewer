...
<body class="bg-[#1A1714] min-h-screen flex items-center justify-center font-['Instrument_Sans'] text-white relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] bg-[#6646E5] rounded-full mix-blend-screen filter blur-[150px] opacity-20"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[700px] h-[700px] bg-[#E0D8FC] rounded-full mix-blend-screen filter blur-[150px] opacity-10"></div>
        
        <div class="absolute inset-0 bg-[#1A1714]/40 backdrop-blur-[12px]"></div>
    </div>

    <div class="relative z-10 w-full max-w-[440px] bg-white/10 backdrop-blur-2xl border border-white/10 rounded-[28px] p-8 md:p-10 flex flex-col items-center shadow-[0_8px_32px_0_rgba(0,0,0,0.5)] mx-4">
        
        <div class="w-16 h-16 bg-[#6646E5] rounded-[18px] flex items-center justify-center shadow-lg mb-6">
        ...
        <h2 class="text-[26px] font-bold text-white font-['Inter'] mb-3 text-center tracking-tight">Log Out Successful</h2>
        <p class="text-[#A39D98] text-[15px] text-center leading-relaxed mb-8">
            Farewell for now! Your study session is securely complete. We've saved your progress and you are now signed out.
        </p>

        <a href="/" class="w-full bg-[#6646E5] hover:bg-[#5538D4] text-white font-semibold text-[16px] rounded-[14px] py-4 transition-colors shadow-md text-center block mb-5">
            OK
        </a>

        <p class="text-[#7C7167] text-[13px] text-center">
            Clicking OK will return you to the home page.
        </p>
